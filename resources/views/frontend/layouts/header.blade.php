                ...
                <li class="nav-item dropdown dropdown-cart">
                    ...
                    <div class="dropdown-menu dropdown-cart-top p-0 dropdown-menu-right shadow-sm border-0">
                        ...
                        <div class="dropdown-cart-top-body border-top p-4">
                            ...
                            <p class="mb-2"><i class="icofont-ui-press text-success food-item"></i> Corn & Peas Salad
                            ...
                            <p class="mb-2"><i class="icofont-ui-press text-danger food-item"></i> Chicken Tikka Sub
                                12" (30 cm) x 1 <span class="float-right text-secondary">$314</span></p>
                            <p class="mb-2"><i class="icofont-ui-press text-danger food-item"></i> Corn & Peas Salad x
                                1 <span class="float-right text-secondary">$209</span></p>
                        </div>
